...
assert_file_contains "Maven JUnit XML report" "$maven_xml" '<testsuite name="javaspec" tests="1" failures="0" errors="0" skipped="0" time="0">'
...
if [ "${JAVASPEC_SKIP_GRADLE_EXAMPLE:-0}" = "1" ]; then
  ...
  assert_file_contains "Gradle JUnit XML report" "$gradle_xml" '<testsuite name="javaspec" tests="1" failures="0" errors="0" skipped="0" time="0">'
