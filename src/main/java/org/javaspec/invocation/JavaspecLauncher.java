...
public final class JavaspecLauncher {
     ...
     * discovered {@code org.javaspec.bootstrap.BootstrapHook} providers, and discovered
     * providers come from the run classloader in deterministic implementation class name order.
     * Activation failures raise {@code org.javaspec.extension.ExtensionLoadingException}
