...
final class UsagePrinter {
    ...
    static void printUsage(PrintStream stream) {
        ...
        stream.println("  javaspec run [--config <file>] [--suite <name>] [--spec-dir <dir>] [--source-dir <dir>] [--classpath <path-list>] [--classpath-file <file>] [--resolve-pom <pom.xml>] [--compile] [--compile-output <dir>] [--release <N>] [--generate] [--dry-run] [--stop-on-failure] [--auto-check-predictions|--no-auto-check-predictions] [--formatter <progress|pretty|json|custom>] [--profile <java8|java11|java17|java21|java25>] [--verbose] [--report <file>] [--generation-report <file>] [--junit-xml <file>] [--constructor-policy <delete|preserve|comment>] [--class <name>] [--example <name>]");
        stream.println("  javaspec prophesize <FQCN> [--package <name>] [--output <dir>] [--overwrite] [--dry-run]");
        stream.println("  javaspec list-extensions");
        stream.println();
        ...
        stream.println("  run                   Discover, generate, compile, and execute selected specifications.");
        stream.println("  prophesize <FQCN>     Generate a typed Prophecy wrapper for an interface or concrete class.");
        stream.println("  list-extensions       List discovered formatters and extensions plus classpath hints.");
        stream.println();
        ...
        stream.println("  --resolve-pom <pom.xml> With run, resolve runtime dependencies from the local Maven repository.");
        ...
        stream.println("  --release <N>         With run compilation, target Java release N.");
