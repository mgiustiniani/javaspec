 ...
 * <p>Extracted from {@link io.github.jvmspec.cli.Main Main} to isolate argument
...
public final class CliArgumentParser {
    ...
    private static String normalizeFormatter(String formatter) {
        return io.github.jvmspec.formatter.RunFormatterRegistry.normalizeName(formatter);
    }
