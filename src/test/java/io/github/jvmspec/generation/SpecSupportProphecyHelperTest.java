...
public class SpecSupportProphecyHelperTest {
    ...
    public void addsTypedProphecyHelperForInterface() {
        ...
        assertTrue("must use Doubles dispatch",
                updated.contains("io.github.jvmspec.doubles.Doubles.interfaceDouble") ||
                updated.contains("io.github.jvmspec.doubles.Doubles.concreteDouble") ||
    ...
    public void typedWrapperReturnTypeCompilesWithVarOnJava10OrLater() throws Exception {
        ...
        write(src, "com/example/MailerProphecy.java",
                ...
                "  public MailerProphecy(io.github.jvmspec.doubles.InterfaceDouble<Mailer> handle, " +
                "io.github.jvmspec.doubles.prophecy.PredictionRegistry registry) {}\n" +
                "  public io.github.jvmspec.doubles.prophecy.MethodProphecy<Boolean> send(String message) { return null; }\n" +
                "}\n");
