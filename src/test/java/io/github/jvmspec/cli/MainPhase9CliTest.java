...
public class MainPhase9CliTest {
    ...
    public void stopOnFailureStopsAfterFailedOrBrokenExampleAndDefaultRunsAllExamples() throws Exception {
        ...
        CommandResult stopAfterFailureResult = run(
                ...
                "--spec-dir", testJavaRoot().getAbsolutePath(),
                "--source-dir", sourceRoot.getAbsolutePath(),
                "--class", "io.github.jvmspec.fixtures.cli.Phase9FailureStopSubject",
                "--formatter", "pretty",
                "--stop-on-failure"
        );
        ...
        assertTrue(stopAfterFailureResult.out.contains("FAILED spec.io.github.jvmspec.fixtures.cli.Phase9FailureStopSubjectSpec#it_fails_first"));
        ...
        assertTrue(defaultFailureResult.out.contains("FAILED spec.io.github.jvmspec.fixtures.cli.Phase9FailureStopSubjectSpec#it_fails_first"));
        assertTrue(defaultFailureResult.out.contains("PASSED spec.io.github.jvmspec.fixtures.cli.Phase9FailureStopSubjectSpec#it_passes_after_failure"));
        assertTrue(defaultFailureResult.out.contains("BROKEN spec.io.github.jvmspec.fixtures.cli.Phase9FailureStopSubjectSpec#it_is_broken_after_failure"));
        ...
        CommandResult stopAfterBrokenResult = run(
                ...
                "--spec-dir", testJavaRoot().getAbsolutePath(),
                "--source-dir", sourceRoot.getAbsolutePath(),
                "--class", "io.github.jvmspec.fixtures.cli.Phase9BrokenStopSubject",
                "--formatter", "pretty",
                "--stop-on-failure"
        );
        ...
        assertTrue(stopAfterBrokenResult.out.contains("BROKEN spec.io.github.jvmspec.fixtures.cli.Phase9BrokenStopSubjectSpec#it_breaks_first"));
    ...
    public void progressFormatterIsConciseAndPrettyFormatterPrintsPerExampleStatuses() throws Exception {
        ...
        assertFalse(progressResult.out.contains("PASSED spec.io.github.jvmspec.fixtures.cli.FailingSubjectSpec#it_passes"));
        ...
        assertTrue(prettyResult.out.contains("PASSED spec.io.github.jvmspec.fixtures.cli.FailingSubjectSpec#it_passes"));
    ...
    public void invalidFormatterExitsUsage() {
        ...
        assertTrue(result.err.contains("Invalid formatter: dots. Valid values: progress, pretty, json."));
