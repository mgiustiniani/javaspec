...
public class MainTest {
    ...
    public void prophesizeConcreteClassUsesGeneratedSourcesNotSrc() throws Exception {
        ...
        File wrapperInTarget = new File(TEST_GENERATED_SOURCES,
                "spec" + File.separator + "io" + File.separator + "github" + File.separator +
                "jvmspec" + File.separator + "cli" + File.separator + "FinalGreeterProphecy.java");
        ...
        CommandResult result = run(
                "prophesize",
                "io.github.jvmspec.cli.MainTest$FinalGreeter",
                "--package", "spec.io.github.jvmspec.cli");
        ...
        assertTrue("nested concrete classes must use Java source names",
                source.contains("io.github.jvmspec.cli.MainTest.FinalGreeter"));
    ...
    public void runWithGenerateWritesMethodSkeletonsAndSpecificationSupportForTypedProxySpec() throws Exception {
        ...
        assertTrue(supportSource.contains("protected io.github.jvmspec.matcher.Matchable<Integer> getRating()"));
        assertTrue(supportSource.contains("return match(subject().getRating());"));
        assertTrue(supportSource.contains("protected io.github.jvmspec.matcher.Matchable<String> getTitle()"));
        assertTrue(supportSource.contains("protected io.github.jvmspec.matcher.Matchable<Boolean> isEnabled()"));
