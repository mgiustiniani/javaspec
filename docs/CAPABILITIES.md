...
- Matcher parity Phase 50 is not implemented beyond existing matchers; approximate, iterable/iterator, dynamic object-state, and inline/configured matcher scope requires a 1.0 decision.
...
| P1-MATCH-001 | P1 | Phase 50 matcher parity is not implemented. | Implement or explicitly defer scope before RC. |
