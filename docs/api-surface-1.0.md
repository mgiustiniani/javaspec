...
|---|---|---|
| `io.github.jvmspec.api` | `PUBLIC_API` | PHPSpec-first authoring API: `ObjectBehavior`, lifecycle helpers, construction helpers, skip/pending signals, direct expectation conveniences, example data rows, and generated-support base hooks. |
