...
- **Release/CI verification assets**: `scripts/verify-all.sh` and `.github/workflows/ci.yml` aggregate core and standalone-adapter verification without changing the root Maven reactor or adding publishing/signing behavior.
