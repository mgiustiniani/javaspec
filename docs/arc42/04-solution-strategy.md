...
- Keep root `mvn verify` scoped to the core artifact unless a future ADR changes the release/build boundary; use `scripts/verify-all.sh` or equivalent explicit commands for aggregate standalone adapter verification.
