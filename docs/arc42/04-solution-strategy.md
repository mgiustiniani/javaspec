...
| Canonical runner, no-JUnit invocation foundation, optional Maven/Gradle plugin adapters, and optional JUnit Platform engine boundary | [ADR 0011](../adr/0011-optional-junit-adapter-and-canonical-javaspec-runner.md) |
