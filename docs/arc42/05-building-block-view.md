...
- The JSON report schema is versioned as `schemaVersion` 1 and contains top-level summary counts, spec results, example results, nullable failure details, throwable class/message, stack trace lines, and Phase 18 additive stable id/source fields.
