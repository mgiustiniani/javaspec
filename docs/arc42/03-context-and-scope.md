...
| CI system | Runs specs, supplies compiled classpaths when needed, consumes exit codes or optional JUnit Platform events, and may collect JSON and/or JUnit XML-compatible runner reports. |
...
- Built-in progress/pretty reporting, optional JSON and JUnit XML-compatible runner reports, and stable exit codes.
