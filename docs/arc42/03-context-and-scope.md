...
| CI system | Runs specs, consumes exit codes, and may collect JSON runner reports. |
...
- Built-in progress/pretty reporting, optional JSON runner reports, and stable exit codes.
