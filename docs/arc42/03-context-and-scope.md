...
- Zero-dependency interface doubles through JDK dynamic proxies, including matcher-aware argument constraints, throwing stubs, and answer callbacks while remaining interface-only.
...
- Stronger interface double behavior without CLI/report/schema/dependency/adapter changes or concrete/static/final/constructor/bytecode mocking.
