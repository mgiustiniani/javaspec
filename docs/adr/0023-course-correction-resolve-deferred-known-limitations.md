...
4. Phase 33 — Optional ServiceLoader discovery of `org.javaspec.bootstrap.BootstrapHook` providers in addition to explicitly configured hooks, with deterministic ordering and zero new dependencies.
