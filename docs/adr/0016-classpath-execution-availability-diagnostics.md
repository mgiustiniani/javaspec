...
- Do not compile source/spec files inside javaspec, do not add compile-time or runtime dependencies for compilation or classpath analysis, and do not change exit-code/build-failure semantics.
...
- javaspec still does not compile source or spec files; users must run the normal project compilation lifecycle and supply compiled outputs/dependencies.
...
Related decisions: [ADR 0006](0006-classpath-reflection-runner.md), [ADR 0011](0011-optional-junit-adapter-and-canonical-javaspec-runner.md), and [ADR 0015](0015-explicit-skipped-and-pending-semantics.md).
