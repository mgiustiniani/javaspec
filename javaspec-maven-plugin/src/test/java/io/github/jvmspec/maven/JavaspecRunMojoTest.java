...
public class JavaspecRunMojoTest {
    ...
    public void configurationBootstrapHooksExecuteBeforeExamplesAndCanChangeObservedBehavior() throws Exception {
        ...
        File specSource = writeSpec(specRoot, "spec.com.example.PluginBootstrapSubjectSpec",
                "    public void it_observes_bootstrap_marker() {\n" +
                        "        io.github.jvmspec.maven.JavaspecRunMojoTest.BootstrapState.record(\"example:\" + io.github.jvmspec.maven.JavaspecRunMojoTest.BootstrapState.marker());\n" +
                        "        if (!\"top-level>suite\".equals(io.github.jvmspec.maven.JavaspecRunMojoTest.BootstrapState.marker())) {\n" +
                        "            throw new AssertionError(\"bootstrap marker was not applied before example: \" + io.github.jvmspec.maven.JavaspecRunMojoTest.BootstrapState.marker());\n" +
                        "        }\n" +
                        "    }\n");
        compile(classesDirectory, specSource);
        CapturingLog log = new CapturingLog();
    ...
    public void invalidFormatterListsExtensionRegisteredFormatterNames() throws Exception {
        ...
        try {
            ...
            assertContains(expected.getMessage(), "Valid values: progress, pretty, json, phase32-available.");
        }
    }
    ...
    public void mojoImplementationDelegatesToCanonicalJavaspecLauncher() throws Exception {
        String source = readFile(pluginProjectFile("src/main/java/io/github/jvmspec/maven/JavaspecRunMojo.java"));
        ...
        assertFalse("Mojo must not bypass the canonical launcher with the low-level runner",
                source.contains("import io.github.jvmspec.runner.SpecRunner;"));
    }
    ...
    private CompiledSpecFixture compiledBootstrapDiscoverySubjectFixture(
        ...
        File specSource = writeSpec(specRoot, "spec.com.example." + describedSimpleName + "Spec",
                "    public void it_runs_after_discovered_bootstrap() {\n" +
                        "        String marker = io.github.jvmspec.maven.JavaspecRunMojoTest.BootstrapState.marker();\n" +
                        "        io.github.jvmspec.maven.JavaspecRunMojoTest.BootstrapState.record(\"example:\" + marker);\n" +
